    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            var cust_list = (from a in dbcon.Customer_Details
                             join b in dbcon.CountryMasters on a.Country equals b.CountryID
                             join c in dbcon.StateMasters on a.State equals c.StateID
                             select new
                             {
        ...
        /// <summary>
        /// Editcustomers the specified custlist.
        /// </summary>
        /// <param name="custlist">The custlist.</param>
        ...
        /// <summary>
        /// Deletecustomers the specified identifier.
        /// </summary>
        ...
        /// <summary>
        /// Changestates the specified c identifier.
        /// </summary>
        /// <param name="c_id">The c identifier.</param>
        /// <returns></returns>
